...
Rails.application.configure do
  ...
  if ENV['REPOST_ASSET_HOST']
    config.action_controller.asset_host = ENV['REPOST_ASSET_HOST']
  end
  ...
  config.active_storage.service = ENV['REPOST_ACTIVE_STORAGE_SERVICE'] || :local
